...
function tournementstart(){
    ...
    console.log('Player3 : ', players[2]);
    console.log('Player4 : ', players[3]);
    formcontainer.innerHTML = '<div id="game"><canvas id="gameCanvas"></canvas></div><div id="xx"><p class="po">Press Space To Start .</p></div>';
    runGame();
};